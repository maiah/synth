...
* `logPath` - Used for logging the Request path and its query parameters. Read the [doc](https://github.com/maiah/synth/wiki/Middleware-logPath) of this middleware.
